...
def admin_view_marks_view(request,pk):
    ...
    for i in results:
        print(i.exam)
    return render(request,'exam/admin_check_marks.html',{'results':results,'name':name, 'reg' : reg_id})

    # response =  render(request,'exam/admin_view_marks.html',{'courses':courses, 'results': results})
...
def tutorial_view(request):
    # tutorialform = forms.TutorialForm()
    return render(request,'exam/tutorial_start.html',{"tutorialform" :forms.TutorialForm}) 