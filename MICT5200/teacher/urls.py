...
path('teacher-tutorial', views.start_tutorial_view,name='teacher-tutorial'),
# path('start-tutorial/<int:pk>', views.start_tutorial_view,name='start-tutorial'),
...
path('remove-tutorial/<int:pk>', views.remove_tutorial_view,name='remove-tutorial'),
path('test', views.exam_mark_check,name='test'),
]